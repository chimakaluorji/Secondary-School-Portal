...
<div class="pcoded-content">
                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="managestudentprofile.php">Classes</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5><button id="create_class_modal_btn" class="btn btn-outline-info btn-sm"><i class="icofont icofont-ui-add"></i>New Class</button></h5>
                        ...
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table id="classes_table" class="display nowrap" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>S/N</th>
                                                <th>Class</th>
    ...
    <div class="modal fade" id="create_class_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12 d-none msg_box" id="create_class_modal_msg_box">
                    ...
                    <div class="col-md-12 d-none" id="create_class_modal_spinner">
                    ...
                    <form id="create_class_form" action="">
                        <div class="col-sm-12 m-b-10">
                            <div class="form-group">
                                <input type="hidden" class="form-control form-control-primary" id="is_edit_class" value="0">

                            </div>

                            <div class="form-group">
                                <input type="hidden" class="form-control form-control-primary" id="class_id" value="0">
                            </div>

                            <div class="form-group">
                                <label for="class_name" class="form-label font-weight-bold">Class</label>
                                <input type="text" class="form-control form-control-primary" id="txt_class_name" placeholder="class">
                ...
                <div class="modal-footer">
                    ...
                    <input type="button" id="create_class_btn" value="Add" class="btn btn-primary waves-effect waves-light" />
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                        ...
                        columns: [{
                            ...
                            },
                            {
                                data: function(data, type, full) {
                                    return `<td><button type="button" class="btn btn-success btn-outline-success edit_class" data-id="${data.id}" data-row_index="${data.sn - 1}"><i class="icofont icofont-check-circled">Manage</button></td>`;
                                }
                            }
                        ],
                ...
                if (response.status == 'fail') {
                    utils.updateMessageBox(messageBox, response.status);
        ...
        $('#create_class_btn').click(function() {
            const modal = document.querySelector('#create_class_modal');
            const spinner = modal.querySelector('#create_class_modal_spinner');

            //collect the filled in data
            const isEdit = parseInt($("#is_edit_class").val());
            const schoolClass = $("#txt_class_name").val();
            const classID = $('#class_id').val();

            $.ajax({
                type: "POST",
                url: isEdit ? 'functions/updateClass.php' : 'functions/createClass.php',
                data: {
                    classID: classID,
                ...
                success: function(response) {
                    ...
                    if (response.status == 'success') {
                        const data = response.data;
                        $('#classes_table').DataTable().clear().rows.add(data).draw();
        ...
        $('#create_class_modal_btn').click(function() {
            const modal = document.querySelector('#create_class_modal');
            modal.querySelector('.modal-title').textContent = 'New Class';
        ...
        $('#create_class_modal').on('hidden.bs.modal', function(e) {
            $('#create_class_form').trigger('reset');
            const messageBox = document.querySelector('#create_class_modal_msg_box');
        ...
        function registerEventHandlers() {
            $('.edit_class').click(function(e) {
                const schoolClass = $('#classes_table').DataTable().row(e.currentTarget.dataset.row_index).data();
                const modal = document.querySelector('#create_class_modal');
                modal.querySelector('.modal-title').textContent = 'Modify Class';

                $("#is_edit_class").val('1');
                $('#class_id').val(schoolClass.id);

                $('#txt_class_name').val(schoolClass.class)
                $('#create_class_modal').modal('show');
            });
        }
