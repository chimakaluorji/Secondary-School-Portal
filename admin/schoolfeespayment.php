                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="col-md-6">
                                <input type="button" id="submit" value="Finalize Result" class="btn btn-grd-primary btn-round" />
                            </div>
                            <br><br>
                            <div class="col-md-6">
                ...
                success: function(data) {
                    ...
                    if (returnfailed != "failed") {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            checkIfTotalIsTheSame(data[i].regnumber, sessionID, termID, classID, classdemarcationID, data[i].stotal, data[i].grade, data[i].remark, position, data[i].average);
